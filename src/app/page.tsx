    ...
    <div className="flex flex-col flex-1 h-screen bg-[#07090e] text-[#f8fafc] overflow-hidden">
      ...
      <div className="flex flex-1 overflow-hidden">
        ...
        <aside className="w-64 border-r border-indigo-950/30 bg-[#07090e]/80 flex flex-col justify-between overflow-y-auto">
          ...
          {/* Connected User */}
          <div className="p-4 border-t border-indigo-950/40 flex items-center gap-3 bg-indigo-950/10">
            <div className="h-9 w-9 rounded-full bg-indigo-600/30 border border-indigo-500/40 flex items-center justify-center font-bold text-indigo-200">
              U
            </div>
            <div>
              <p className="text-xs font-semibold text-slate-200">Vibe Coder</p>
              <p className="text-[10px] text-slate-400">Solo Developer</p>
            </div>
          </div>
        </aside>
